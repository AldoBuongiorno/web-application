...
<body id="body">
    ...
    <div class="travel-adv">
        ...
        <div class="valuta">
            <p>Ovviamente non in ogni paese dell'europa si può pagare con l'euro. Ti può essere utile una lista dei
                paesi in cui dovrai fare il cambio valuta:</p>
            <div class="nation">
        ...
        <div class="slideshow-container">
            <div class="mySlides fade">
                <div class="slide-container">
                    ...
                    <div class="textEU">Interrail Eurail è il sito ufficiale per acquistare il pass europeo,<br> in modo
                        da viaggiare in tutta calma e sicurezza</div>
                </div>
            </div>
            ...
            <div class="mySlides fade">
                <div class="slide-container">
                    ...
                    <div class="textTR">Trivago è uno dei migliori siti per la prenotazione di hotel e appartamenti in
                        cui soggiornare, durante il tuo viaggio</div>
                </div>
            </div>
            ...
            <div class="mySlides fade">
                <div class="slide-container">
                    ...
                    <div class="textBNB">Airbnb offre l'opzione alternativa a Trivago, soprattutto se si punta a
                        risparmiare qualche euro a discapito della comodità</div>
                </div>
            </div>
            <div class="mySlides fade">
                <div class="slide-container">
                    ...
                    <div class="textTRIT">Trenitalia, ferrovie dello stato italiano. Sito fondamentale per controllare
                        l'orario dei treni da usufruire, partendo ovviamente dall'Italia</div>
                </div>
            </div>
            <div class="mySlides fade">
                <div class="slide-container">
                    ...
                    <div class="textTRLine">Trainline, uno dei siti migliori per gli orari dei treni in tutta europa
                    </div>
                </div>
            </div>
            <div class="mySlides fade">
                <div class="slide-container">
                    ...
                    <div class="textADV">Tripadvisor, sito in cui potrete trovare recensioni accurate su ogni paese e
                        regione</div>
                </div>
            </div>
