...
if(!isset($_SESSION['authorized'])){
    ...
    <div id="Menu">
        <div class="logo"><a href="../Home/prj_home.php" id="logo"><img src="../Images/imgHome/LogoSito.png" alt="logosito" class="logoSito"></a></div>
        <div class="dropdown" >
            <button class="dropbtn" id="btnMenu" onclick="openMenu();"><img src="../Images/imgHome/menu.png" style="height: 30px; width: 30px"></button>
