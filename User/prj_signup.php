    ...
    <div class="mainContainer" id="main">
        ...
        <div class="containerSignup form-container" id="container">
            <form name="signupForm" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>"
                ...
                <input type="text" name="name" id="name" placeholder="Nome" <?php if (array_key_exists('name', $_POST)) {
                    echo "value='", htmlspecialchars($_POST['name']), "'";
                } ?> />
                <input type="text" name="surname" id="surname" placeholder="Cognome" <?php if (array_key_exists('surname', $_POST)) {
                ...
                <input type="password" name="passwordSignup" id="passwordSignup" placeholder="Password" <?php if (array_key_exists('passwordSignup', $_POST)) {
                    echo "value='", htmlspecialchars($_POST['passwordSignup']), "'";
                } ?> />
                <input type="password" name="passwordConfirm" id="passwordConfirm" placeholder="Conferma Password" <?php if (array_key_exists('passwordConfirm', $_POST)) {
                ...
                <button id="switchSignup" type="button" onclick="window.location.href = 'prj_login.php';">
                    <Login>
                </button>
            </form>
        </div>
